...
from src.core.models import EscapeScore, ViralSequence, Mutation
...
class ImmuneEscapeModel:
    ...
    KNOWN_ESCAPE_MUTATIONS = {
        "K417N": {"class1": 0.8, "class2": 0.1, "class3": 0.05, "class4": 0.1, "ace2": -0.15},
        "K417T": {"class1": 0.7, "class2": 0.1, "class3": 0.05, "class4": 0.1, "ace2": -0.10},
        "L452R": {"class1": 0.1, "class2": 0.6, "class3": 0.3, "class4": 0.05, "ace2": 0.10},
        "T478K": {"class1": 0.2, "class2": 0.3, "class3": 0.1, "class4": 0.05, "ace2": 0.05},
        "E484K": {"class1": 0.3, "class2": 0.9, "class3": 0.2, "class4": 0.1, "ace2": -0.05},
        "E484A": {"class1": 0.2, "class2": 0.7, "class3": 0.15, "class4": 0.1, "ace2": 0.02},
        "F486V": {"class1": 0.4, "class2": 0.6, "class3": 0.1, "class4": 0.05, "ace2": -0.20},
        "F486P": {"class1": 0.3, "class2": 0.5, "class3": 0.1, "class4": 0.05, "ace2": 0.15},
        "Q493R": {"class1": 0.5, "class2": 0.3, "class3": 0.1, "class4": 0.05, "ace2": 0.20},
        "N501Y": {"class1": 0.6, "class2": 0.1, "class3": 0.1, "class4": 0.05, "ace2": 0.35},
        "Y505H": {"class1": 0.4, "class2": 0.1, "class3": 0.05, "class4": 0.05, "ace2": -0.10},
        "D614G": {"class1": 0.05, "class2": 0.05, "class3": 0.05, "class4": 0.05, "ace2": 0.20},
        "P681H": {"class1": 0.05, "class2": 0.05, "class3": 0.05, "class4": 0.05, "ace2": 0.05},
        "P681R": {"class1": 0.05, "class2": 0.05, "class3": 0.1, "class4": 0.05, "ace2": 0.10},
        "N440K": {"class1": 0.1, "class2": 0.1, "class3": 0.6, "class4": 0.1, "ace2": 0.05},
        "G339D": {"class1": 0.05, "class2": 0.05, "class3": 0.1, "class4": 0.4, "ace2": 0.02},
        "S371L": {"class1": 0.1, "class2": 0.1, "class3": 0.2, "class4": 0.7, "ace2": -0.05},
        "S371F": {"class1": 0.1, "class2": 0.1, "class3": 0.2, "class4": 0.75, "ace2": -0.03},
        "S373P": {"class1": 0.1, "class2": 0.1, "class3": 0.15, "class4": 0.65, "ace2": -0.02},
        "R346T": {"class1": 0.1, "class2": 0.1, "class3": 0.7, "class4": 0.1, "ace2": 0.0},
        "V445P": {"class1": 0.05, "class2": 0.1, "class3": 0.5, "class4": 0.05, "ace2": 0.0},
        "G446S": {"class1": 0.05, "class2": 0.05, "class3": 0.6, "class4": 0.05, "ace2": -0.05},
        "N460K": {"class1": 0.3, "class2": 0.2, "class3": 0.1, "class4": 0.1, "ace2": 0.05},
        "S477N": {"class1": 0.15, "class2": 0.2, "class3": 0.05, "class4": 0.05, "ace2": 0.10},
    }
    ...
    def compute_escape_score(self, sequence_id: str, lineage: str,
                              mutations: list[Mutation]) -> EscapeScore:
        """
        ...
        for m in mutations:
            ...
            if notation in self.KNOWN_ESCAPE_MUTATIONS:
                ...
                for cls in self.ANTIBODY_CLASSES:
                    class_scores[cls] = min(1.0, class_scores[cls] + effects.get(cls, 0.0))
                ...
                for cls in self.ANTIBODY_CLASSES:
                    class_scores[cls] = min(1.0, class_scores[cls] + estimated_effect.get(cls, 0.0))
        ...
        overall_escape = sum(class_scores[cls] * weights[cls] for cls in self.ANTIBODY_CLASSES)
        ...
        escaped_epitopes = sorted(class_scores.items(), key=lambda x: x[1], reverse=True)
        most_escaped = [f"{cls} ({score:.2f})" for cls, score in escaped_epitopes if score > 0.3]
    ...
    def _estimate_unknown_mutation_effect(self, mutation: Mutation, rng: random.Random) -> dict:
    ...
    def compare_variants(self, scores: list[EscapeScore]) -> dict:
        ...
        comparison["least_escaped"] = min(scores, key=lambda x: x.overall_escape).lineage if scores else None
